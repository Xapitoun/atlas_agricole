...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="C1_moyenne_sa > 0 AND C1_moyenne_sa &lt;= 50" symbol="0" label="0.4500 - 511.9970"/>
      <rule filter="C1_moyenne_sa > 50 AND C1_moyenne_sa &lt;= 100" symbol="1" label="511.9970 - 1023.5440"/>
      <rule filter="C1_moyenne_sa > 100 AND C1_moyenne_sa &lt;= 200" symbol="2" label="1023.5440 - 1535.0910"/>
      <rule filter="C1_moyenne_sa > 200 AND C1_moyenne_sa &lt;= 300" symbol="3" label="1535.0910 - 2046.6380"/>
      <rule filter="C1_moyenne_sa > 300 AND C1_moyenne_sa &lt;= 2600" symbol="4" label="2046.6380 - 2558.1850"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="199,233,192,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="style" v="solid"/>
