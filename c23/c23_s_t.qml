...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="s_enti_moyenne_saison" symbollevels="0" type="graduatedSymbol">
    <ranges>
      <range symbol="0" lower="0.000000" upper="4.000000" label="&lt;= 4"/>
      <range symbol="1" lower="4.000000" upper="122.000000" label="4 - 122"/>
      <range symbol="2" lower="122.000000" upper="240.000000" label="122 - 240"/>
      <range symbol="3" lower="240.000000" upper="358.000000" label="240 - 358"/>
      <range symbol="4" lower="358.000000" upper="425.000000" label="358 - 425"/>
    </ranges>
    <symbols>
    ...
    <colorramp type="gradient" name="[source]">
      ...
      <prop k="color2" v="5,80,35,255"/>
      <prop k="discrete" v="0"/>
      <prop k="stops" v="0.25;170,255,127,255:0.5;0,229,0,255:0.75;7,138,29,255:0.9;6,103,31,255"/>
    </colorramp>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="0" type="0" name="arb_s_ajeune"/>
    <edittype labelontop="0" editable="0" type="0" name="arb_s_aproductif"/>
    <edittype labelontop="0" editable="0" type="0" name="arb_s_id_culture"/>
    <edittype labelontop="0" editable="0" type="0" name="arb_s_n_culture"/>
    <edittype labelontop="0" editable="0" type="0" name="arb_s_pc"/>
    <edittype labelontop="0" editable="0" type="0" name="arb_s_tot_a"/>
    ...
    <edittype labelontop="0" editable="0" type="0" name="s_enti_tot_s"/>
  </edittypes>
  <editform>.</editform>
